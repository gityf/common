...
#define EXPECT_GE(a,b) ::common::test::Tester(__FILE__, __LINE__).IsGe((a),(b))
#define EXPECT_GT(a,b) ::common::test::Tester(__FILE__, __LINE__).IsGt((a),(b))
#define EXPECT_LE(a,b) ::common::test::Tester(__FILE__, __LINE__).IsLe((a),(b))
...
#define TEST_INFO(fmt, arg...) do { fprintf(stderr, "\033[0;33m[ INFO     ] " fmt "\n", ##arg); } while (0)
}  // namespace test
}  // namespace common
