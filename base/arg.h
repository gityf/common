...
namespace common {
    ...
    public:
        ...
        /** @brief Read and extract commandline parameters from argc/argv.
            ...
            {
            common::Arg<int> option_n(argc, argv, 'n', 0);
    ...
    public:
        ...
        /**
         ...
         example:
         \code
         common::Arg<unsigned> offset(argc, argv, 'o', 0);
        ...
        /**
         ...
         example:
         \code
         common::Arg<int> option_number(argc, argv, "--number", 0);
    ...
    /**
     ...
     example:
     \code
     common::Arg<bool> debug(argc, argv, 'd');
     if (debug)
    ...
    public:
        ...
        /**
         ...
         \code
         common::Arg<bool> debug(argc, argv, 'd');
         common::Arg<bool> ignore(argc, argv, 'i');
         \endcode
